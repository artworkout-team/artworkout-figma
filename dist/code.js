...
/*!*************************************!*\
  !*** ./src/app/components/uiRPC.ts ***!
  \*************************************/
/*! exports provided: setAnimationTags, updateUiProps */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setAnimationTags", function() { return setAnimationTags; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateUiProps", function() { return updateUiProps; });
/* harmony import */ var _models_TuneFormStore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/TuneFormStore */ "./src/app/models/TuneFormStore.ts");
...
function setAnimationTags(animationTag, delay, repeat) {
    return __awaiter(this, void 0, void 0, function* () {
        yield _models_TuneFormStore__WEBPACK_IMPORTED_MODULE_0__["TuneFormStore"].setAnimationTags(animationTag, delay, repeat);
    });
}
function updateUiProps(settings) {
    return __awaiter(this, void 0, void 0, function* () {
        yield _models_TuneFormStore__WEBPACK_IMPORTED_MODULE_0__["TuneFormStore"].updateProps(settings);
    });
}
...
const TuneFormStore = Object(valtio__WEBPACK_IMPORTED_MODULE_0__["proxy"])({
    ...
    setAnimationTags(animationTag, delay, repeat) {
        return __awaiter(this, void 0, void 0, function* () {
            TuneFormStore.formProps = Object.assign(Object.assign({}, TuneFormStore.formProps), { animationTag,
                delay,
                repeat });
        });
    },
    updateProps(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log('updateProps', Object.assign(Object.assign({}, TuneFormStore.formProps), settings));
            TuneFormStore.formProps = Object.assign(Object.assign({}, TuneFormStore.formProps), settings);
        });
    },
});
...
function selectionChanged() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (selection || lesson || selection.type !== 'FRAME') {
            ...
            const delay = Object(_util__WEBPACK_IMPORTED_MODULE_0__["getParamValue"])(tags, /^d(\d+)/) || Object(_util__WEBPACK_IMPORTED_MODULE_0__["getParamValue"])(tags, /^d-(\d+)/);
            const repeat = Object(_util__WEBPACK_IMPORTED_MODULE_0__["getParamValue"])(tags, /^r(\d+)/) || Object(_util__WEBPACK_IMPORTED_MODULE_0__["getParamValue"])(tags, /^r-(\d+)/);
...
const uiApi = Object(figma_jsonrpc__WEBPACK_IMPORTED_MODULE_0__["createUIAPI"])({
    ...
    updateUiProps: _app_components_uiRPC__WEBPACK_IMPORTED_MODULE_8__["updateUiProps"],
});
