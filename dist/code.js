...
/*!****************************!*\
  !*** ./src/plugin/meta.ts ***!
  \****************************/
/*! exports provided: availableTypes, getSettingsNode, setMetaTags, getMetaTags, setMetaTagsFromNodesToStore */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "availableTypes", function() { return availableTypes; });
...
const getMetaTags = (lesson) => {
    ...
    metaTags.forEach(el => {
        ...
        if (el.startsWith('meta-type-')) {
            metaObject = Object.assign(Object.assign({}, metaObject), { type: el.replace('meta-type-', '') });
        }
    });
    return metaObject;
};
