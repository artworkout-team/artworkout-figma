...
function lintInput(page, node) {
    ...
    Object(_util__WEBPACK_IMPORTED_MODULE_0__["descendantsWithoutSelf"])(node).forEach((v) => {
...
function lintStep(page, step) {
    ...
    const terminalNodes = Object(_util__WEBPACK_IMPORTED_MODULE_0__["descendantsWithoutSelf"])(step).filter((v) => v['children'] == undefined);
...
/*!****************************!*\
  !*** ./src/plugin/util.ts ***!
  \****************************/
/*! exports provided: findAll, findLeafNodes, findParent, getNodeIndex, getCurrentLesson, getTags, findTag, addTag, findParentByTag, isResultStep, print, displayNotification, descendants, descendantsWithoutSelf, capitalize, getStepOrder, resizeUi, setStepOrder */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
