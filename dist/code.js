...
function nameLeafNodes(nodes) {
    let allStrokes = nodes.find((node) => 'fills' in node && node.fills !== figma.mixed && node.fills.length > 0) === undefined;
