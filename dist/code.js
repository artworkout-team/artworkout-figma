...
function displayTemplate(lesson, step) {
    ...
    const templateGroup = step.findChild((g) => Object(_util__WEBPACK_IMPORTED_MODULE_1__["getTags"])(g).includes('template'));
    if (templateGroup) {
        step.visible = true;
        input.visible = false;
