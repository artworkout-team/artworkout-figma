...
function addAnimationTag(step, tag, delay, repeat) {
    if (figma.currentPage.selection) {
        ...
        selectionTags = selectionTags.filter((t) => !/d\d+/.test(t) &&
            !/r\d+/.test(t) &&
            !/r-\d+/.test(t) &&
            !/d-\d+/.test(t));
        if (tag) {
