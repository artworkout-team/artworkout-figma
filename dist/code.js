...
function collectLayerNumbersToClear(lesson, step) {
    ...
    const isResult = Object(_util__WEBPACK_IMPORTED_MODULE_1__["isResultStep"])(step);
    const clearLayerNumbers = lesson.children.reduce((acc, layer, i) => {
        ...
        if (Object(_util__WEBPACK_IMPORTED_MODULE_1__["getTags"])(layer).includes('clear-before') &&
            Object(_util__WEBPACK_IMPORTED_MODULE_1__["getStepNumber"])(layer) <= currentStepNumber) {
