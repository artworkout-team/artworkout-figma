...
function selectionChanged() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (selection || lesson || selection.type !== 'FRAME') {
            ...
            const stepNumber = stepsByOrder(lesson).indexOf(parentStep) + 1 > 0
        ...
        const stepNumber = stepsByOrder(lesson).indexOf(step) + 1 > 0
