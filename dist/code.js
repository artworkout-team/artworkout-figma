...
function getLayerNumbersForClearBefore(lesson, step) {
    const layersStepNumbers = lesson.children.map((s) => Object(_util__WEBPACK_IMPORTED_MODULE_1__["getStepNumber"])(s));
    let stepsToClear = [];
    if (Object(_util__WEBPACK_IMPORTED_MODULE_1__["getTags"])(step).includes('clear-before')) {
        stepsToClear = [...Array(Object(_util__WEBPACK_IMPORTED_MODULE_1__["getStepNumber"])(step)).keys()].slice(1);
    }
