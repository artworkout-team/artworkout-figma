...
/*!******************************!*\
  !*** ./src/plugin/linter.ts ***!
  \******************************/
/*! exports provided: ErrorLevel, selectError, printErrors, lintPage, lintCourse, saveErrors, maximizeUi, minimizeUi */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "maximizeUi", function() { return maximizeUi; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "minimizeUi", function() { return minimizeUi; });
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "./src/plugin/util.ts");
/* harmony import */ var _tune__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tune */ "./src/plugin/tune.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
...
function lintPage(currentPage, isCourseLinting) {
    if (!isCourseLinting) {
        errors = [];
    }
...
const pluginApi = Object(figma_jsonrpc__WEBPACK_IMPORTED_MODULE_0__["createPluginAPI"])({
    ...
    maximizeUi: _plugin_linter__WEBPACK_IMPORTED_MODULE_6__["maximizeUi"],
    minimizeUi: _plugin_linter__WEBPACK_IMPORTED_MODULE_6__["minimizeUi"],
});
