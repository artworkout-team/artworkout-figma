...
/*!******************************!*\
  !*** ./src/plugin/create.ts ***!
  \******************************/
/*! exports provided: createLesson, separateStep, nearBlack, splitByColor, joinSteps */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function importTexts(strings) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!parentStep || Object(_util__WEBPACK_IMPORTED_MODULE_1__["isResultStep"])(parentStep)) {
            return;
        }
        yield figma.loadFontAsync({ family: 'Inter', style: 'Regular' });
        const textNodes = strings.map((string) => {
            const text = figma.createText();
            text.characters = string;
            text.fontSize = 25;
            text.fills = [{ type: 'SOLID', color: _create__WEBPACK_IMPORTED_MODULE_0__["nearBlack"] }];
            return text;
        });
        if (textNodes.length === 0) {
            Object(_util__WEBPACK_IMPORTED_MODULE_1__["displayNotification"])('Empty input');
            return;
        }
