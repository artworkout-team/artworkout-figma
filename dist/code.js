...
function lintFills(node, page, fills) {
    const rgbt = Object(_util__WEBPACK_IMPORTED_MODULE_0__["findTag"])(node, /^rgb-template$/) || Object(_util__WEBPACK_IMPORTED_MODULE_0__["findParentByTag"])(node, 'rgb-template');
...
function lintGroup(page, node) {
    ...
    const rgbt = tags.find((s) => /^rgb-template$/.test(s)) || Object(_util__WEBPACK_IMPORTED_MODULE_0__["findParentByTag"])(node, 'rgb-template');
