...
function exportCourse() {
    return __awaiter(this, void 0, void 0, function* () {
        const lessons = yield Promise.all(figma.root.children.filter((page) => page.name != 'INDEX').map(page => exportLesson(page)));
        const thumbnail = yield figma.root.children.find((page) => page.name == 'INDEX').exportAsync({
            format: 'PNG',
            constraint: {
                type: 'WIDTH',
                value: 600,
