...
function separateStep() {
    ...
    const parentStep = Object(_util__WEBPACK_IMPORTED_MODULE_0__["findParent"])(nodes[0], (n) => Object(_util__WEBPACK_IMPORTED_MODULE_0__["getTags"])(n).includes('step'));
    if (!parentStep || Object(_util__WEBPACK_IMPORTED_MODULE_0__["getTags"])(parentStep).includes('s-multistep-result')) {
        return;
    }
...
function splitByColor() {
    ...
    const firstStep = lesson.children.find((el) => {
        const tags = Object(_util__WEBPACK_IMPORTED_MODULE_0__["getTags"])(el);
