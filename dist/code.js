...
function showOnlyRGBTemplate(group) {
    if (Object(_util__WEBPACK_IMPORTED_MODULE_1__["getTags"])(group).includes('settings')) {
        group.visible = false;
        return;
    }
    if (Object(_util__WEBPACK_IMPORTED_MODULE_1__["getTags"])(group).includes('rgb-template') || (/GROUP|BOOLEAN_OPERATION/.test(group.type) && !group.children)) {
        return;
    }
...
/*!****************************!*\
  !*** ./src/plugin/util.ts ***!
  \****************************/
/*! exports provided: findAll, findLeafNodes, findParent, getNodeIndex, getCurrentLesson, getTags, findTag, addTag, findParentByTag, isResultStep, print, displayNotification, capitalize, getStepOrder, setStepOrder, descendants, descendantsWithoutSelf */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
