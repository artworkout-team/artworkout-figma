...
const TuneFormStore = Object(valtio__WEBPACK_IMPORTED_MODULE_0__["proxy"])({
    ...
    setAnimationTags(animationTag, delay, repeat) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            TuneFormStore.stepProps = Object.assign(Object.assign({}, TuneFormStore.stepProps), { animationTag,
                delay,
                repeat });
    ...
    updateProps(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            TuneFormStore.mutex = true;
            TuneFormStore.stepProps = Object.assign(Object.assign({}, TuneFormStore.stepProps), settings);
            TuneFormStore.mutex = false;
        });
    },
});
Object(valtio__WEBPACK_IMPORTED_MODULE_0__["subscribe"])(TuneFormStore.stepProps, () => {
    console.log('stepProps changed', TuneFormStore.stepProps);
    if (!TuneFormStore.mutex) {
        _rpc_api__WEBPACK_IMPORTED_MODULE_1__["pluginApi"].updateProps(JSON.parse(JSON.stringify(TuneFormStore.stepProps)));
        _rpc_api__WEBPACK_IMPORTED_MODULE_1__["pluginApi"].updateDisplay({ stepNumber: TuneFormStore.stepNumber, displayMode: TuneFormStore.displayMode });
    }
});
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "./src/plugin/util.ts");
/* harmony import */ var _rpc_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../rpc-api */ "./src/rpc-api.ts");
/* harmony import */ var _app_models_TuneFormStore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../app/models/TuneFormStore */ "./src/app/models/TuneFormStore.ts");
/* harmony import */ var valtio__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! valtio */ "./node_modules/valtio/index.js");
/* harmony import */ var valtio__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(valtio__WEBPACK_IMPORTED_MODULE_3__);
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
function updateProps(settings) {
    ...
    const obj = Object(valtio__WEBPACK_IMPORTED_MODULE_3__["snapshot"])(_app_models_TuneFormStore__WEBPACK_IMPORTED_MODULE_2__["TuneFormStore"]);
    console.log('shadowSize', obj.stepProps, _app_models_TuneFormStore__WEBPACK_IMPORTED_MODULE_2__["TuneFormStore"].stepProps, 1);
