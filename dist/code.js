...
function lintStrokes(node, page, strokes) {
    ...
    assert(node.strokeAlign == 'CENTER' || !rgbt, `Stroke align must be 'CENTER' but is '${String(node.strokeAlign)}'`, page, node, ErrorLevel.ERROR);
