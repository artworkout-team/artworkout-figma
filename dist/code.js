...
function getColor(node) {
    ...
    switch (node.type) {
        ...
        case 'GROUP': {
            const nodes = Object(_util__WEBPACK_IMPORTED_MODULE_0__["findLeafNodes"])(node);
            if (nodes.length > 0) {
