...
function lintFills(node, page, fills) {
    ...
    fills.forEach((f) => {
        ...
        if (f.type === 'IMAGE') {
            assert(f.opacity == 1 || !rgbt, 'Image fill must not be opaque', page, node);
        }
    });
}
