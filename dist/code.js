...
function updateDisplay(settings, page) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const continueButtonValue = Object(_util__WEBPACK_IMPORTED_MODULE_0__["getBooleanTagValue"])(step, 'continue-button');
        yield _rpc_api__WEBPACK_IMPORTED_MODULE_1__["uiApi"].updateUiProps({
            ...
            brushType,
            continueButton: continueButtonValue !== undefined ? continueButtonValue : undefined,
            allowUndo: Object(_util__WEBPACK_IMPORTED_MODULE_0__["getBooleanTagValue"])(step, 'allow-undo'),
            resizeBrush: Object(_util__WEBPACK_IMPORTED_MODULE_0__["getBooleanTagValue"])(step, 'resize-brush'),
            shareButton: Object(_util__WEBPACK_IMPORTED_MODULE_0__["getBooleanTagValue"])(step, 'share-button'),
        });
...
/*!****************************!*\
  !*** ./src/plugin/util.ts ***!
  \****************************/
/*! exports provided: stepTemplates, findAll, findLeafNodes, findParent, getNodeIndex, getCurrentLesson, getTags, findTag, addTag, findParentByTag, isResultStep, getBooleanTagValue, print, displayNotification, capitalize, getStepOrder, resizeUi, setStepOrder, getAllTree, descendants, getParamValue, isRGBTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "stepTemplates", function() { return stepTemplates; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getBooleanTagValue", function() { return getBooleanTagValue; });
...
function getBooleanTagValue(node, tag) {
    if (!node)
        return undefined;
